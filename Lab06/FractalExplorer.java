...
public class FractalExplorer {
    ...
    */
    private class SaveActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            fileChooser.setAcceptAllFileFilterUsed(false);  // состояние фильтровщика файлов
            int t = fileChooser.showSaveDialog(displayImage);
            if (t == JFileChooser.APPROVE_OPTION) {
                try {
                    ImageIO.write(displayImage.picture, "png", fileChooser.getSelectedFile()); // запись файла в директорию пользователя
                } catch (Exception ee) {
    ...
    */
    ...
    /**
    * Calculates colors of all pixel in the row for he selected complexPlaneRange and fractal type in background thread. (universal parametrs)
    * */
    ...
    /**
    * method that actually performs background operations.
    */
    @Override
    ...
    /**
    * method is called when the background task is completed.
    */
    @Override
    public void done() {
        for (int x = 0; x < displaySize; x++) {
